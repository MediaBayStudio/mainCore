// Css User Agent (cssua.js) v2.1.29
...
(function ($, window, document) {
    ...
    var Carousel = {
        ...
        onVisibleItems : function () {
            $("div.slide_content").css("display", "none").delay(500).queue(function(next){
                $(this).fadeIn(500);
                next();
            });
